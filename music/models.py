...
class Album(models.Model):
    ...
    contributors = models.ManyToManyField(AlbumContributors, through='AlbumContributors')
...
class Song(models.Model):
    ...
    contributors = models.ManyToManyField(SongContributors, through='SongContributors', related_name="song_contributors")
